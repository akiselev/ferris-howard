...
def load_kuna_truth():
    ...
    spec = importlib.util.spec_from_file_location("fh_kuna_truth", path)
...
def select(e0_path: Path, repo: Path, count: int) -> dict:
    ...
    return {
        "schema": "fh-kuna-e1-mc0-manifest-v1",
        ...
        "source": {
            ...
            "extractor": "atlas-extract/FhAtlas/Extract.lean",
            "extractor_sha256": sha256(ROOT / "atlas-extract/FhAtlas/Extract.lean"),
            "search_method": "HomeIndex.carrier_statement_candidates",
            "detector": "scripts/fh_home.py",
            "detector_sha256": sha256(ROOT / "scripts/fh_home.py"),
        },
        "selection": {
