"""A full-tree parser for the I3 encoding (`fh-stmt-v1`), for the dimensional experiment.

`scripts/fh_home.py` deliberately does *not* build trees: it needs only a telescope's
...
Grammar, read off `atlas-extract/FhAtlas/Statement.lean` rather than off any prose:
