...
from fh_home import Reader, TAG_B, TAG_LEN  # noqa: E402
...
# minutes of nothing. Node counting follows `fh_home.node_count` exactly — `c(`, `s(`,
...
def telescope2(encoding: str, limit: int = 512):
    ...
    `fh_home.telescope` discards the conclusion's arguments; the census wants their count,
...
def cmd_erasure(args, corpus=None) -> None:
    ...
    if corpus is None:
        ...
        corpus = fh_atlas.Corpus.load(args.slice)
    c = corpus
