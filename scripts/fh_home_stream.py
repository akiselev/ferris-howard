...
`fh_home.HomeIndex` keeps every row, which is fine for a 145 MB slice and impossible for the
...
The verdict rule is `fh_home`'s, unchanged: same forgetful-instance traversal, same
