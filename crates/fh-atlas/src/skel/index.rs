...
mod tests {
    ...
    fn closure_by_finds_an_unclosed_stratum_a_global_figure_hides() {
        ...
        let mut rows = vec![
            ...
            row("Known", "Math", "fh-stmt-v1;pi(s(0),pd(b0,s(0)))"),
            ...
            row(
                "Phys.a",
                "Phys",
                "fh-stmt-v1;pi(s(0),a(a(c(7:Missing,0),b0),b0))",
            ),
        ];
        ...
        for i in 0..9 {
            rows.push(row(
                &format!("Math.t{i}"),
                "Math",
                "fh-stmt-v1;pi(s(0),a(a(c(5:Known,0),b0),b0))",
            ));
        }
    ...
    fn vocabulary_adjacent_admits_the_rare_constant_and_not_the_common_one() {
        ...
        for i in 0..20 {
            rows.push(row(
                &format!("common{i}"),
                &format!(
                    "fh-stmt-v1;a(a(c(2:Eq,0),c(1:{},0)),c(1:z,0))",
                    (b'a' + i) as char
                ),
            ));
        }
    ...
    fn adjacent_excludes_the_class_and_names_the_edit() {
        ...
        let src = [
            row("cls_a", "fh-stmt-v1;a(a(c(2:Eq,0),c(1:x,0)),c(1:y,0))"),
            row("cls_b", "fh-stmt-v1;a(a(c(2:Eq,0),c(1:x,0)),c(1:y,0))"),
            row("near", "fh-stmt-v1;a(a(c(2:Ne,0),c(1:x,0)),c(1:y,0))"),
            row("decoy", "fh-stmt-v1;a(c(2:Eq,0),a(c(1:x,0),c(1:y,0)))"),
        ]
        .join("\n");
        let mut idx = SkeletonIndex::build(&src, &IndexConfig::default()).expect("build");
    ...
    fn variants_finds_the_one_substitution_and_rejects_the_reshuffle() {
        ...
        let src = [
            row("subject", "fh-stmt-v1;a(a(c(2:Eq,0),c(1:x,0)),c(1:y,0))"),
            // one slot differs: Eq -> Ne
            row("one_sub", "fh-stmt-v1;a(a(c(2:Ne,0),c(1:x,0)),c(1:y,0))"),
            // two slots differ
            row("two_sub", "fh-stmt-v1;a(a(c(2:Ne,0),c(1:z,0)),c(1:y,0))"),
...
\"stmt\":\"fh-stmt-v1;pi(s(0),pt(a(c(8:Preorder,1,0),b0),pd(b1,a(a(a(c(2:Eq,1,0),b2),b0),b0))))\",\
\"uses_statement\":[],\"uses_proof\":[]}
{\"name\":\"noclass\",\"kind\":\"theorem\",\"module\":\"M\",\
\"stmt\":\"fh-stmt-v1;pi(s(0),pd(b0,a(a(a(c(2:Eq,1,0),b1),b0),b0)))\",\
\"uses_statement\":[],\"uses_proof\":[]}
";
