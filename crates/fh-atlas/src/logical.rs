...
const GENERATOR: &str = concat!("fh-atlas/logical@", env!("CARGO_PKG_VERSION"));
...
mod tests {
    ...
    fn a_quantifier_is_not_an_implication() {
        ...
        let (a, t) = arena_with("fh-stmt-v1;pd(c(3:Nat,0),a(c(4:Even,0),b0))");
    ...
    fn a_non_dependent_arrow_is_an_implication() {
        ...
        let (a, t) = arena_with("fh-stmt-v1;pd(c(3:Nat,0),pd(a(c(4:Even,0),b0),a(c(3:Odd,0),b1)))");
    ...
    fn mentions_bvar_sees_through_binders_with_the_right_shift() {
        ...
        let (a, t) = arena_with("fh-stmt-v1;pd(c(3:Nat,0),a(a(c(1:f,0),b0),b1))");
    ...
    fn an_iff_is_recognised_under_its_quantifiers() {
        let (a, t) = arena_with(
            "fh-stmt-v1;pd(c(3:Nat,0),a(a(c(3:Iff,0),a(c(4:Even,0),b0)),a(c(3:Odd,0),b0)))",
        );
