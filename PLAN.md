...
- ◐ **C1.** `fh check` v0 landed 2026-08-01 (see A1.9). v1 at M2: role metadata, error taxonomy with branch hints, friendly-wording layer over Lean's raw messages, `simp?` feedback on simp success.
